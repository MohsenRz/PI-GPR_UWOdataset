""" 
making a simple LSTM model for CSO data prediction for comparison
...
def plot_results(timestamps_train, Y_train, Y_pred_train,
    ...
    ax.set_title(f'LSTM: CSO Prediction (Train: {train_days} days, Test: {test_hours} hours)', 
                 fontsize=14)
...
def main():
    ...
    print("="*70)
    print("LSTM Model for CSO Prediction (Exogenous)")
    print("="*70)
    ...
    seq_length = 24 # 2 hours of data (5 min intervals)
