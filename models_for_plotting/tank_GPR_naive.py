...
def build_gpr_model(X_train, Y_train, time_std_dev):
    ...
    ### kernel design 
    time_kernel = gpflow.kernels.RBF(lengthscales=scaled_period, variance=0.1, active_dims=[0]) 
    ...
    kernel_rain.lengthscales = gpflow.Parameter(0.3, transform=bounded_transform_rain)
...
def main():
    ...
    save_path = BASE / "results" / "Tank_level_outputs" / "2019_Tank_GPR_kernel.pkl"
