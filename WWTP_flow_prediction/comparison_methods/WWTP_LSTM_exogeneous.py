...
IT IS AN EXOGENEOUS PREDICTIVE MODEL, NOT AN END-TO-END MODEL 
Author: Mohsen 
...
def preparing_data(merged_data, start_time, interval_minutes=timeinterval, lag_minutes=120,
    ...
    # THE FIX: Removed 'inflow' from X_multi so the model is purely exogenous
    X_multi = np.hstack((sin_time, cos_time, rain_accum))
    Y = inflow
