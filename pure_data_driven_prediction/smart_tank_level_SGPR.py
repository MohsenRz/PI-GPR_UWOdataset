...
a smart sparsification nmethod is applied here with putting more inducing points on the wet-weather periods. 
...
def build_sgpr_model(X_train, Y_train, time_std_dev, threshold_scaled):
    """
    Build and train the SGPR model
    Added threshold_scaled argument for smart initialization
    """ 
...
def main():
    ...
    print("\nTraining SGPR model...")
    # Pass Time Std Dev and the scaled threshold
