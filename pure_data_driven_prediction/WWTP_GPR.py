...
def find_optimal_rain_lag(merged_data, interval_minutes, max_lag_hours=1, lag_step_minutes=15):
    """
...
def main():
    ...
    X_train, Y_train, timestamps_train = preparing_data(merged_train, train_start_time, timeinterval, lag_minutes=105)
    ...
    # --- PREDICTION ON TEST ---
    X_test, Y_test, timestamps_test = preparing_data(merged_test, train_start_time, timeinterval, lag_minutes=105)
